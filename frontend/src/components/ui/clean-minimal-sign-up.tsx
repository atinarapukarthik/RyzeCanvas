...
export function SignUp({ onSubmit, onSignInClick, className }: SignUpProps) {
	...
	return (
		<div className={cn("w-full", className)}>
			...
			<div className="flex gap-3 w-full justify-center mt-2">
				<button className="flex items-center justify-center w-12 h-12 rounded-xl border border-border bg-background hover:bg-muted transition grow">
